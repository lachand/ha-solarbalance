...
_BATTERY_SCHEMA = vol.Schema(
    {
        ...
        vol.Optional("charge_limit_soc_setpoint_entity"): _ENTITY,
        vol.Optional("charge_ceiling_soc_pct"): vol.All(vol.Coerce(int), vol.Range(0, 100)),
        vol.Optional("charge_priority_target_soc_pct"): vol.All(vol.Coerce(int), vol.Range(0, 100)),
        ...
        vol.Optional("discharge_mirror_group"): str,
    }
)
...
def _build_battery_role(raw: Mapping[str, Any]) -> BatteryRole:
    return BatteryRole(
        ...
        extra_power_entities=tuple(raw.get("extra_power_entities") or ()),
        ...
        charge_limit_soc_setpoint_entity=raw.get("charge_limit_soc_setpoint_entity"),
        charge_ceiling_soc_pct=raw.get("charge_ceiling_soc_pct"),
        charge_priority_target_soc_pct=raw.get("charge_priority_target_soc_pct"),
        ...
        discharge_mirror_group=raw.get("discharge_mirror_group"),
    )
