...
> **Status**: **v2.0.0 released** (stable). Core engine, all strategies, **active hardware control**, zero-injection, the **SoC equaliser** (PV-gated, auto-tuned), watchdog, services and Lovelace examples are functional. Next: the rest of Wave 4 (consumption forecasting, battery-health throttling, real-time PV-drop detection).
