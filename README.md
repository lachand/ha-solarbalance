...
> **Status**: v2.0 in beta — latest pre-release **v2.0.0-beta.11** (enable beta versions in HACS). Core engine, all strategies, **active hardware control**, zero-injection, the **SoC equaliser**, watchdog, services and Lovelace examples are functional. Wave 4 (predictive intelligence & battery-health throttling) is in progress.
