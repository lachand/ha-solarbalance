...
> **Status**: **v2.0.7 released** (stable). Core engine, all strategies, **active hardware control**, zero-injection (progressive gain), the **SoC equaliser** (PV-gated), watchdog, services and Lovelace examples are functional. Next: the rest of Wave 4 (consumption forecasting, battery-health throttling, real-time PV-drop detection).
